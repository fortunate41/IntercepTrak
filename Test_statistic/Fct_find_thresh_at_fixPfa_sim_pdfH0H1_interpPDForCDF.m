function [ thresh_gamma, Pd, xaxH0, cdfH0_interp, xaxH1, cdfH1_interp ] = ...
    Fct_find_thresh_at_fixPfa_sim_pdfH0H1_interpPDForCDF( zH1, zH0, fixed_Pfa, interpPDF_true)
...
temp = zH1(:);
[histo_correct, edgesH1] = histcounts(temp, bins);
xaxH1 = edgesH1(1:end-1)+ diff(edgesH1)/2;
...
%plot(xaxH0, pdfH0, 'b--s'); hold on; plot(xaxH1, pdfH1, 'r--s'); drawnow; pause(0.1); line([thresh_gamma thresh_gamma], [0 0.06], 'linewidth', 3); hold off; legend ('H0','H1', 'Threshold')
%% 
